...
public class Constant {
	...
	public static final String APP_NAME = "SZKCB";

	public static final String ROOT_SRC = Environment
			.getExternalStorageDirectory().getAbsolutePath();
	public static final String SAVE_PATH = ROOT_SRC + "/SZKCB/"; // 本地存放资源路径
	...
	public static final String DOWNLOAD_APK_NAME = SAVE_PATH + "SZKCB.apk";
